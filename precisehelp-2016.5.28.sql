...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`goods_id`) REFERENCES `goodsinfo` (`goods_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `goodsinfo` (
  ...
  `goods_stat` text,
  `goods_last_price` double(20,0) DEFAULT NULL,
  `goods_now_price` double(20,0) DEFAULT NULL,
